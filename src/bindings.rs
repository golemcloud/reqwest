...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.36.0:reqwest:wasi:http-client:encoded world"]
#[doc(hidden)]
...
\x0c\x04\0\x06handle\x01\x0d\x03\0\x20wasi:http/outgoing-handler@0.2.0\x05\x0e\x04\
\0\x18reqwest:wasi/http-client\x04\0\x0b\x11\x01\0\x0bhttp-client\x03\0\0\0G\x09\
